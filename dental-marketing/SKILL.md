...
description: >
  치과 구강 스캐너의 **불특정 다수 대상 홍보 콘텐츠**를 기획·제작하는 스킬.
    담당: 브로셔, 리플렛, 랜딩페이지, SNS 게시물, 광고 카피, 슬로건 후보, 영상·유튜브 기획, AI 이미지 프롬프트, 전시회 홍보물, 콘텐츠용 한영일 번역.
    쓰지 않는 경우: 특정 고객 1곳을 향한 제안서·견적·팔로업 이메일은 `dental-sales-strategy`,
    색상·타이포그래피 등 브랜드 시스템 정의는 `brand` 스킬,
    Anthropic 회사 브랜드를 다루는 `brand-guidelines`와는 **무관하므로 혼동 금지**.
---
