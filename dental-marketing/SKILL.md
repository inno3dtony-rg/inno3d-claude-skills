...
description: >
  치과 구강 스캐너 및 치과 장비의 B2B·B2C 마케팅 전략·콘텐츠·캠페인을 온/오프라인 채널에서 기획·실행하는 전문 스킬.
  마케팅 전략, 콘텐츠 기획, SNS, 이메일 마케팅, 제품 포지셔닝, 브랜드, 광고, 전시회 마케팅, 고객 여정,
  리플렛, 랜딩페이지, 슬로건, 번역, 이미지 프롬프트, 유튜브, 영상 기획 관련 요청 시 반드시 이 스킬을 사용한다.
  키워드: 마케팅 전략, dental marketing, 콘텐츠 마케팅, SNS 마케팅, B2B 마케팅, 제품 포지셔닝,
  전시회, 브로셔, 리플렛, 캠페인, 이메일, LinkedIn, 유튜브, 치과 광고, Densflo, 이노쓰리디, SIDEX
---
